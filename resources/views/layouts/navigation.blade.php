@php
    ...
    $icon = [
        ...
        'shield'  => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />',
    ];
@endphp
...
<aside x-cloak
    ...
    <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-5">
        ...
        <div class="space-y-1">
            ...
            <x-sidebar-link :href="route('security.index')" :active="request()->routeIs('security.*')" :icon="$icon['shield']">
                Security Center
            </x-sidebar-link>
        </div>
        ...
        <div class="space-y-1">
            ...
            <x-sidebar-link :href="route('billing.customers')" :active="request()->routeIs('billing.*')" :icon="$icon['card']">
                Customer Billing
            </x-sidebar-link>
        </div>
        @endif
        ...
        <div class="space-y-1">
            ...
            <x-sidebar-link :href="route('email-scans.index')" :active="request()->routeIs('email-scans.index') || request()->routeIs('email-scans.analyze')" :icon="$icon['envelope']">
                Email Scans
            </x-sidebar-link>
            <x-sidebar-link :href="route('risk-analysis')" :active="request()->routeIs('risk-analysis') || request()->routeIs('email-scans.show')" :icon="$icon['report']">
                Risk Analysis
            </x-sidebar-link>
        ...
        <div class="space-y-1">
            ...
            @if(! $isSuper)
            <x-sidebar-link :href="route('subscription.index')" :active="request()->routeIs('subscription.*')" :icon="$icon['card']">
                Subscription
            </x-sidebar-link>
            @endif
